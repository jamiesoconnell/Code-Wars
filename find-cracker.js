...
function findHack(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      if (grades.length >= 5 && numBOrAbove === grades.length) {
        calculatedPoints += 20;
      }
  
      if (calculatedPoints > 200 || calculatedPoints !== totalPoints) {
